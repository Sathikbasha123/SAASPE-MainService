...
@Service
public class DatadogWrapperServImpl implements DatadogWrapperService {

	@Value("${datadog.createUser.api.url}")
	private String createUserUrl;
	
	@Value("${datadog.getUser.api.url}")
	private String getUserUrl;
	
	@Value("${datadog.deleteUser.api.url}")
	private String deleteUserUrl;
	
	@Value("${adapters.host.url}")
	private String adaptorsHost;
	
private static final Logger log = LoggerFactory.getLogger(DatadogWrapperServImpl.class);
